...
class smTemplate:
    ...
    def generateSmStaActionDefine(self):
        """生成状态机各状态操作定义"""
        comments = self.__cTemp.generateFunctionComment2(self.__fileName+'_act_init()',self.__fileName+'Rec - 状态记录参数指针','无','初始状态操作函数')
        ...
        comments += ("\n"*1)
        comments += self.__cTemp.generateFunctionComment2(self.__fileName+'_act_default()',self.__fileName+'Rec - 状态记录参数指针','无','默认状态操作函数')
        ...
        comments += ("\n"*1)
        for sta in self.__sta_list:
            comments += self.__cTemp.generateFunctionComment2(self.__fileName+'_act_'+sta+'()',self.__fileName+'Rec - 状态记录参数指针','无','状态'+sta+'操作函数')
    ...
    def createSource(self):
        ...
        self.__cTemp.fileComments2['Description'] = ': 状态机'+self.__fileName+'定义及各状态动作定义源文件'
    ...
    def createHeader(self):
        ...
        self.__cTemp.fileComments2['Description'] = ': 状态机'+self.__fileName+'声明及状态机使用示例头文件'
